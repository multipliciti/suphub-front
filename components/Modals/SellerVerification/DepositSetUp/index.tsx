...
export const DepositSetUp = () => {
	...
	const fillDefaultValueInternationalBank = (data: any) => {
		const { swiftCode, businessName, accountNumber, addressLine1, addressLine2 } =
			data;
					...
					{selectedCountry === 'United States' ? (
						<div className={s.content_group}>
							<div className={s.content_input_group}>
								...
								<div className={s.content_title_group}>
									...
									<Image
										...
										alt={'question icon'}
										title={
											'This name will appear on your payment. Business names cannot contain accented letters nor exceed 35 characters.'
										}
									/>
								</div>
							...
							<div className={s.content_input_group}>
								...
								<label
									...
									htmlFor="accountNumberDomesticBank"
								>
									<input
						...
						<div className={s.content_group}>
							...
							<div className={s.content_input_group}>
								...
								<label
									className={classNames(s.label)}
									htmlFor="businessNameInternational"
								>
									<input
							...
							<div className={s.content_input_group}>
								...
								<label
									className={classNames(s.label)}
									htmlFor="accountNumberInternational"
								>
									<input
