	...
	return (
		<div className={s.wrapper}>
			<div className={s.header}>
				<div
					onClick={backToEditPassword}
					className={s.header_back_btn}>
					<Image
						src={back_btn}
						alt='back_btn'
						width={24}
				...
				<span onClick={closeModal} className={s.header_close}>
					<Image className={s.header_close} src={modal_close} alt='modal_close' width={15} height={15} />
				</span>
			</div>
			<div className={s.content}>
				<Image className={s.content_img} src={checkmark} alt="checkmark" />
				<div className={s.content_title}>Password changed</div>
				<div className={s.content_text}>Your password has been changed successfully.</div>
			</div>
		</div>
	);
};