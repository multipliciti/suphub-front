		...
		return (
			<div className={s.content_group}>
				...
				<div className={s.steps}>
					<div className={classNames(s.step, s.step_status)}>
						<div className={s.step_logotitle_group}>
							<div className={classNames(s.step_logo, s.step_logo_status)}>
								<svg
									className={classNames(s.step_logo_img, s.step_logo_img_submitted)}
						...
						{/*>*/}
						{/*	<div className={s.step_btn_text}>Start</div>*/}
						{/*</button>*/}
						<button
							onClick={(e) => {
								e.preventDefault();
						...
						>
							<Image src={time_in_review_icon} alt={'review time icon'} />
							<div
								className={classNames(s.step_btn_text, s.step_btn_text_in_review)}
							>
								In Review
							</div>
						</button>
