...
function SuccessPage () {
	...
	return (
		<div className={s.message}>
			<Image
				className={s.img_success}
				src={checkmark}
				alt='checkmark'
			/>
			<h1 className={s.title}>Payment Successful</h1>
			<div className={s.desc}>Your payment has been successfully processed. Thank you for your purchase!</div>
			<button
				className={s.btn}
				onClick={() => router.push('/testSellerRFQ')}
			>
