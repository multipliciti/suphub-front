				...
				<div className={s.content_group}>
					<div className={s.main_group}>
						<div className={s.main_logo_bg}>
							...
							{sellerCompany?.status === 'businessVerified' && (
								<Image
									alt={'Time logo'}
									className={s.main_logo}
									width={44}
						...
						<div className={s.main_text_group}>
							...
							{sellerCompany?.status === 'declined' && (
								<>
									...
									<div className={s.main_text}>
										Your verification did not pass our review. We will refund your
										fee within 5-7 business days.
									</div>
								</>
							)}
							{sellerCompany?.status === 'verified' && (
					...
					<div className={s.steps}>
						<div
							className={classNames(
								s.step,
								sellerCompany?.status !== 'notVerified' && s.step_status
							)}
						>
							<div className={s.step_logotitle_group}>
								<div
									className={classNames(
										s.step_logo,
										sellerCompany?.status !== 'notVerified' && s.step_logo_status
									)}
								>
									<svg
										className={classNames(
						...
						<div
							className={classNames(
								s.step,
								sellerCompany?.status === 'verified' && s.step_status
							)}
						>
							<div className={s.step_logotitle_group}>
								<div
									className={classNames(
										s.step_logo,
										sellerCompany?.status === 'verified' && s.step_logo_status
									)}
								>
									<svg
										xmlns="http://www.w3.org/2000/svg"
							...
							{sellerCompany?.subscription?.paid ? (
								<button className={classNames(s.step_btn_status)}>
									<Image src={check_done} alt={'check icon'} />
									<div className={classNames(s.step_btn_text, s.step_btn_text_done)}>
										Done
